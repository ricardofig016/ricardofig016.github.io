 ...
 * @param {string} hex - Hex color (e.g., "#61DAFB")
 ...
 * @returns {string} - Hex color (e.g., "#61DAFB")
 */
...
/**
 * Generate background color from color
 * @param {string} color - Hex color of the logo (e.g., "#61DAFB")
